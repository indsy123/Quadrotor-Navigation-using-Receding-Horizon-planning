...
class velocity_controller(object): 
    def __init__(self, name_of_uav, number, freq, parameters): 
        ...
        self.target_position = ar([[0.0],[-10.0],[1.5]])
        #self.previous_pdes = ar([[0.0],[0.0],[0]])
        ...
        open('rotation_error.txt', 'w').close()
    ...
    def target_callback(self, data): 
        ...
        self.camera_fov_planning = True
        self.target_position = ar([[data.pose.pose.position.x], [data.pose.pose.position.y], [data.pose.pose.position.z]])
    ...
    def odom_callback(self, odom): 
        ...
        if index == -1: 
            ...
            ff.write("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s\n" % (index, current_time, t, Xd[0][0], Xd[1][0], Xd[2][0], Vd[0][0], Vd[1][0], Vd[2][0], ad[0][0], ad[1][0], ad[2][0]))
            ...
            ff.write("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s\n" % (phi, b1d[0][0], b1d[1][0], b1d[2][0], -eR_hat[1][2], eR_hat[0][2], -eR_hat[0][1], eOmega[0][0], eOmega[1][0], eOmega[2][0]))
    
            T = tp(ar([[self.M[0][0],self.M[1][0]-0.286,self.M[2][0],self.f[0][0]]])) # dummy torque to offset visensor moment
            ...
            ff.write("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s\n" % (w[0][0], w[1][0], w[2][0], w[3][0], w[4][0], w[5][0], self.M[0][0],self.M[1][0]-0.28,self.M[2][0],self.f[0][0]))
