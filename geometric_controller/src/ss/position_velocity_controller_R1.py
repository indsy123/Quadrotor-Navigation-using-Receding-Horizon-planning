...
class velocity_controller(object): 
    def __init__(self, name_of_uav,parameters): 
        ...
        try:
            ...
            traj = message_filters.Subscriber('/NavigationFunctionTrajectory', velocities_from_navigation_function, tcp_nodelay = False)
            accel = message_filters.Subscriber('/'+self.uav+'/ground_truth/imu', Imu, tcp_nodelay = False)
