...
class velocity_controller(object): 
    def __init__(self, name_of_uav, number, freq, parameters): 
        ...
        open("traj_time_in_odom.txt", "w").close()
        ...
        try: 
            ...
            print 'could not subscribe to one of the topics above'
    ...
    def odom_callback(self, odom): 
        ...
        if index == -1: 
            ...
            ff.write("%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s\n" % (index, self.odom_time, self.traj_start_time, Xd[0][0], Xd[1][0], Xd[2][0], Vd[0][0], Vd[1][0], Vd[2][0], ad[0][0], ad[1][0], ad[2][0]))
