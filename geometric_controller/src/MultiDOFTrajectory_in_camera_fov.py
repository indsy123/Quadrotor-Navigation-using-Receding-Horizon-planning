...
class RHP(object): 
    ...
    def plan_in_camera_fov(self, pc_data):
        ...
        if self.goal_moving == False and distance_to_goal < self.sensor_range and self.RHPendcounter == 0:
        ...
        elif self.goal_moving == False and distance_to_goal >= self.sensor_range and self.stopping_now == False:             
